<?php
    ...
    $select_post_by_id = mysqli_query($con,$query);
    ...
    if(isset($_POST['update_post']))
    {
          ...
          $query .= "WHERE post_id = {$the_post_id} ";
            ...
            if(!$update_post)
            {
                die("query fail".mysqli_error($update_post));
            }
            echo "<p class = 'bg-success'>Post Update : <a href='../post-details.php?p_id={$the_post_id}'>View Post</a> OR <a href='post.php'>Edit More Post</a></p>";
    }
...
<div class="form-group">
    ...
    ?>
      ...
      <div class="form-group">
       ...
       <input width="100px" value="../images/<?php echo  $post_image; ?>"  type="file" class="form-control" name="image">
      </div>
